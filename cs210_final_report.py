# -*- coding: utf-8 -*-
"""CS210_Final_Report.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PGSFMiCm0KO25OLnwWHlHOXPG6t2MnL0
...
# **Work division:**
*   Ardacan Dağ - Cleaning and Manipulation of the Data
*   Begüm Çelik - Report and organization
*   Gülçin Uras - Interpretation and visulization of the data
*   Güren İçim - Interpretation and visulization of the data
*   İbrahim Murat Karakaya - Machine Learning
"""
...
"""**This prediction accuracy which has been achieved by Random Forest Classifier method, is higher than the previous one. However, in order to achieve more reliable results in the next step of this project, more column should be cleaned and taken into account to increase prediction accuracy.**"""
